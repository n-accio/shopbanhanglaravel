...
class ProductController extends Controller
{
    ...
    public function details_product($product_slug , Request $request){
        ...
        return view('pages.sanpham.show_details')->with('cate_product',$cate_product)
        ->with('brand_product',$brand_product)->with('product_details',$product_details)
        ->with('related_product',$related_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)
