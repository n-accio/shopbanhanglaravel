    ...
    <div class="col-sm-4">
        <div class="product-image-wrapper">
            <div class="single-products">
                    ...
                    <input class="cart_product_qty_{{$product->product_id}}" type="hidden" value="1">
                    <a href="{{URL::to('chi-tiet-san-pham/'.$product->product_slug)}}">
                        <img src="{{URL::to('public/uploads/product/'.$product->product_image)}}" alt="" />
                        ...
                        <button type="button" data-id_product="{{$product->product_id}}" class="btn btn-default add-to-cart" name="add-to-cart">Thêm giỏ hàng</button>
                    </form> --}}
                    </div>
